...
copyright = '<a href="http://wol.ph/">%s</a>' % about['__copyright__']
...
github_profile_url = github_url + '{{ cookiecutter.github_username }}/'
github_project_url = github_profile_url + '{{ cookiecutter.repo_name }}/'
